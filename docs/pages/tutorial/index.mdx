...
**Note:** that in order to view the project you must open it using the Registry Playground: https://everymundo.github.io/registry/playground/?url=http://localhost:3000/
