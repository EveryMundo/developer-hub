...
- **Template** review the module as it will appear in different positions within a page
...
The user can either manually enter test scenarios one by one, or upload a JSON file with preset scenarios to load in the UI. 
