...
**Editor** is a tool from the **Developer Hub** that accelerates the construction of the digital contract [**Setup.json**](/learning/setup-file) without the need for the module to be developed yet.
