...
This is a detailed guide to accelerate the migration of existing _PROS modules_ to the **Developer Hub Ecosystem**. It serves as a complement to other tools for organizing internal processes.
...
- In the root of the build folder there should be a `setup.json` file
- The project must install and use the `@everymundo/registry-script` dependency
