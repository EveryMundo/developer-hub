"use strict";
(self["webpackChunk_everymundo_registry_playground"] = self["webpackChunk_everymundo_registry_playground"] || []).push([[569],{
...
/* harmony default export */ const OverviewAddon_module = ({"panel":"j","modulePayloadBar":"k","tempTitle":"l"});
...
const createReactComponent = (type, iconName, iconNamePascal, iconNode) => {
  const Component = (0,react.forwardRef)(
    ({ color = "currentColor", size = 24, stroke = 2, className, children, ...rest }, ref) => (0,react.createElement)(
      "svg",
      {
        ref,
...
const Flex = (0,react.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.a, __spreadProps(__spreadValues({}, others), {
    sx: [
      { display: "flex" },
